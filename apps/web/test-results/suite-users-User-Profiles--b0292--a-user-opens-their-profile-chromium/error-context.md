...
- Name: suite-users.spec.ts >> User Profiles >> clicking a user opens their profile
- Location: e2e/suite-users.spec.ts:53:3
...
Locator: locator('.user-card, .user-row').filter({ hasText: 'profile_b_1775844875961' }).first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.user-card, .user-row').filter({ hasText: 'profile_b_1775844875961' }).first()
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e9]:
      - textbox "Search by username or name..." [ref=e10]: profile_b_1775844875961
      - button "Search users" [ref=e11] [cursor=pointer]: 🔍
    - generic [ref=e12]:
      - generic [ref=e13]: Showing 1–20 of 65 users
