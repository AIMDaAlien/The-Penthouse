...
<div class="settings-pane v3-variant-7">
...
<style>
  ...
  .card {
    ...
    border-radius: 40px; /* Variation in border radius */
  ...
  .layout-container { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px; }
