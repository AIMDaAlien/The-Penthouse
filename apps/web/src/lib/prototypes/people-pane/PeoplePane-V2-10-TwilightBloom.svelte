...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #fff1f2; --bg-grad-2: #f5f3ff; --text-main: #1f2937; --text-muted: #4b5563; --glass-bg: rgba(255, 255, 255, 0.6); --glass-border: rgba(255, 255, 255, 0.8); --glass-shadow: rgba(0,0,0,0.06); --accent-purple: #db2777; --accent-glow: rgba(219, 39, 119, 0.2); --search-bg: rgba(255,255,255,0.8); --search-focus: #fff; --br: 24px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #1e1020; --bg-grad-2: #120b18; --text-main: #f9fafb; --text-muted: #d1d5db; --glass-bg: rgba(50, 20, 50, 0.25); --glass-border: rgba(244, 114, 182, 0.2); --glass-shadow: rgba(0,0,0,0.5); --accent-purple: #f472b6; --accent-glow: rgba(244, 114, 182, 0.2); --search-bg: rgba(40, 15, 40, 0.4); --search-focus: rgba(60, 25, 60, 0.6); } }
