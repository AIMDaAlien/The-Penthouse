...
<style>
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #f8fafc; --bg-grad-2: #f3e8ff; --text-main: #334155; --text-muted: #64748b; --glass-bg: linear-gradient(135deg, rgba(255,255,255,0.8), rgba(255,255,255,0.4)); --glass-border: rgba(255, 255, 255, 0.9); --glass-shadow: 0 4px 20px rgba(0,0,0,0.06); --accent-purple: #c084fc; --accent-glow: rgba(192, 132, 252, 0.3); --search-bg: rgba(255,255,255,0.7); --search-focus: #fff; --br: 20px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #14121c; --bg-grad-2: #1c1528; --text-main: #f8fafc; --text-muted: #cbd5e1; --glass-bg: linear-gradient(135deg, rgba(60,40,80,0.3), rgba(30,20,40,0.1)); --glass-border: rgba(216, 180, 254, 0.2); --glass-shadow: 0 4px 20px rgba(0,0,0,0.5); --accent-purple: #e9d5ff; --accent-glow: rgba(233, 213, 255, 0.2); --search-bg: rgba(40,30,60,0.4); --search-focus: rgba(60,40,90,0.6); } }

	.pane-container {
		width: 100%; height: 100%; max-width: 860px; height: 760px;
	...
	.glass-header h2 {
		margin: 0; font-size: 28px; font-weight: 400; letter-spacing: -0.5px;
	...
	.search-bar input {
		...
		border-radius: 9999px; color: var(--text-main); font-size: 16px; font-family: inherit;
	...
	.search-bar input:focus {
		background: var(--search-focus); border-color: var(--accent-purple);
	...
	.glass-panel {
		...
		border: 1px solid var(--glass-border); border-radius: calc(var(--br) - 8px);
	...
	.glass-panel:hover {
		...
		box-shadow: 0 16px 40px rgba(0,0,0,0.1), 0 0 24px var(--accent-glow);
	}
	@media (prefers-color-scheme: dark) {
		.glass-panel:hover { box-shadow: 0 16px 40px rgba(0,0,0,0.4), 0 0 24px var(--accent-glow); }
	}
	...
	.username { font-size: 13px; color: var(--accent-purple); opacity: 0.9; }
