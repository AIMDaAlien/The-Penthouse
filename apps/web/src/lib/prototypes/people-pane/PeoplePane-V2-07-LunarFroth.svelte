...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #f8fafc; --bg-grad-2: #f1f5f9; --text-main: #1e293b; --text-muted: #475569; --glass-bg: radial-gradient(circle at 20% 20%, rgba(255,255,255,0.9), rgba(255,255,255,0.4)); --glass-border: rgba(255, 255, 255, 1); --glass-shadow: rgba(0,0,0,0.05); --accent-purple: #c084fc; --accent-glow: rgba(192, 132, 252, 0.25); --search-bg: rgba(255,255,255,0.8); --search-focus: #fff; --br: 36px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #14141e; --bg-grad-2: #0b0b12; --text-main: #f8fafc; --text-muted: #cbd5e1; --glass-bg: radial-gradient(circle at 20% 20%, rgba(60,50,80,0.4), rgba(20,15,30,0.2)); --glass-border: rgba(216, 180, 254, 0.15); --glass-shadow: rgba(0,0,0,0.4); --accent-purple: #e9d5ff; --accent-glow: rgba(233, 213, 255, 0.2); --search-bg: rgba(40,35,60,0.5); --search-focus: rgba(60,50,90,0.7); } }
