...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #faf5ff; --bg-grad-2: #f8fafc; --text-main: #1e293b; --text-muted: #64748b; --glass-bg: rgba(255, 255, 255, 0.7); --glass-border: rgba(216, 180, 254, 0.3); --glass-shadow: rgba(0, 0, 0, 0.04); --accent-purple: #a855f7; --accent-glow: rgba(168, 85, 247, 0.2); --search-bg: rgba(255, 255, 255, 0.9); --search-focus: #ffffff; --br: 28px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #1e1b2e; --bg-grad-2: #0f0e17; --text-main: #f1f5f9; --text-muted: #94a3b8; --glass-bg: rgba(45, 40, 70, 0.25); --glass-border: rgba(216, 180, 254, 0.1); --glass-shadow: rgba(0, 0, 0, 0.4); --accent-purple: #c084fc; --accent-glow: rgba(192, 132, 252, 0.2); --search-bg: rgba(30, 25, 50, 0.6); --search-focus: rgba(40, 35, 70, 0.8); } }
