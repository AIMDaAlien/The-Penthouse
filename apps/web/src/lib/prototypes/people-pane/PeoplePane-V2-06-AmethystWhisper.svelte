...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #faf5ff; --bg-grad-2: #f3f4f6; --text-main: #374151; --text-muted: #6b7280; --glass-bg: rgba(255, 255, 255, 0.55); --glass-border: rgba(255, 255, 255, 0.7); --glass-shadow: rgba(0,0,0,0.06); --accent-purple: #9333ea; --accent-glow: rgba(147, 51, 234, 0.2); --search-bg: rgba(255,255,255,0.7); --search-focus: #fff; --br: 22px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #181024; --bg-grad-2: #110c18; --text-main: #f3f4f6; --text-muted: #9ca3af; --glass-bg: rgba(45, 25, 65, 0.25); --glass-border: rgba(192, 132, 252, 0.2); --glass-shadow: rgba(0,0,0,0.4); --accent-purple: #d8b4fe; --accent-glow: rgba(216, 180, 254, 0.2); --search-bg: rgba(35, 20, 50, 0.5); --search-focus: rgba(55, 30, 80, 0.7); } }
