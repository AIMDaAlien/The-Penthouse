...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #fdf4ff; --bg-grad-2: #fdf2f8; --text-main: #334155; --text-muted: #64748b; --glass-bg: rgba(255, 255, 255, 0.65); --glass-border: rgba(232, 121, 249, 0.3); --glass-shadow: rgba(0,0,0,0.04); --accent-purple: #c026d3; --accent-glow: rgba(192, 38, 211, 0.2); --search-bg: rgba(255,255,255,0.8); --search-focus: #fff; --br: 16px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #1c1024; --bg-grad-2: #120a18; --text-main: #f8fafc; --text-muted: #94a3b8; --glass-bg: rgba(55, 25, 75, 0.2); --glass-border: rgba(232, 121, 249, 0.2); --glass-shadow: rgba(0,0,0,0.3); --accent-purple: #e879f9; --accent-glow: rgba(232, 121, 249, 0.2); --search-bg: rgba(40, 20, 60, 0.5); --search-focus: rgba(60, 30, 90, 0.7); } }
