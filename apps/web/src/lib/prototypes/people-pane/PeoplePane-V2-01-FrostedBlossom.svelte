...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #fdf2f8; --bg-grad-2: #f1f5f9; --text-main: #334155; --text-muted: #64748b; --glass-bg: rgba(255, 255, 255, 0.6); --glass-border: rgba(255, 255, 255, 0.8); --glass-shadow: rgba(0, 0, 0, 0.05); --accent-purple: #c084fc; --accent-glow: rgba(192, 132, 252, 0.2); --search-bg: rgba(255, 255, 255, 0.8); --search-focus: rgba(255, 255, 255, 1); --br: 24px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #1a1525; --bg-grad-2: #121018; --text-main: #f8fafc; --text-muted: #94a3b8; --glass-bg: rgba(45, 35, 60, 0.3); --glass-border: rgba(192, 132, 252, 0.15); --glass-shadow: rgba(0, 0, 0, 0.3); --accent-purple: #d8b4fe; --accent-glow: rgba(216, 180, 254, 0.15); --search-bg: rgba(35, 25, 50, 0.5); --search-focus: rgba(45, 30, 65, 0.7); } }
