...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #f8fafc; --bg-grad-2: #f1f5f9; --text-main: #334155; --text-muted: #64748b; --glass-bg: rgba(255, 255, 255, 0.7); --glass-border: rgba(255, 255, 255, 0.9); --glass-shadow: rgba(0,0,0,0.05); --accent-purple: #a855f7; --accent-glow: rgba(168, 85, 247, 0.2); --search-bg: rgba(255,255,255,0.8); --search-focus: #fff; --br: 24px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #161520; --bg-grad-2: #100f18; --text-main: #f8fafc; --text-muted: #94a3b8; --glass-bg: rgba(45, 40, 60, 0.35); --glass-border: rgba(192, 132, 252, 0.2); --glass-shadow: rgba(0,0,0,0.4); --accent-purple: #d8b4fe; --accent-glow: rgba(216, 180, 254, 0.2); --search-bg: rgba(35, 30, 50, 0.6); --search-focus: rgba(50, 45, 70, 0.8); } }
