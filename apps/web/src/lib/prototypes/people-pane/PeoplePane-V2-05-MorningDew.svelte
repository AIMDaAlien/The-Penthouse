...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #f8fafc; --bg-grad-2: #e0e7ff; --text-main: #334155; --text-muted: #64748b; --glass-bg: rgba(255, 255, 255, 0.85); --glass-border: rgba(255, 255, 255, 1); --glass-shadow: rgba(0,0,0,0.05); --accent-purple: #8b5cf6; --accent-glow: rgba(139, 92, 246, 0.2); --search-bg: rgba(255,255,255,0.9); --search-focus: #fff; --br: 24px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #151520; --bg-grad-2: #101018; --text-main: #e2e8f0; --text-muted: #94a3b8; --glass-bg: rgba(40, 40, 60, 0.4); --glass-border: rgba(167, 139, 250, 0.2); --glass-shadow: rgba(0,0,0,0.3); --accent-purple: #c4b5fd; --accent-glow: rgba(196, 181, 253, 0.2); --search-bg: rgba(30, 30, 50, 0.6); --search-focus: rgba(50, 50, 80, 0.8); } }
