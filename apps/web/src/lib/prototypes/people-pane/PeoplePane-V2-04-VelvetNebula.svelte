...
:root { --font-sans: 'Ubuntu', sans-serif; }
	.pane-container { --bg-grad-1: #fdf4ff; --bg-grad-2: #f1f5f9; --text-main: #475569; --text-muted: #94a3b8; --glass-bg: rgba(255, 255, 255, 0.5); --glass-border: rgba(255, 255, 255, 0.6); --glass-shadow: rgba(0,0,0,0.03); --accent-purple: #d946ef; --accent-glow: rgba(217, 70, 239, 0.15); --search-bg: rgba(255,255,255,0.6); --search-focus: rgba(255,255,255,0.9); --br: 32px; }
	@media (prefers-color-scheme: dark) { .pane-container { --bg-grad-1: #1a1025; --bg-grad-2: #0f0a15; --text-main: #f8fafc; --text-muted: #94a3b8; --glass-bg: rgba(50, 25, 70, 0.2); --glass-border: rgba(232, 121, 249, 0.15); --glass-shadow: rgba(0,0,0,0.4); --accent-purple: #f0abfc; --accent-glow: rgba(240, 171, 252, 0.2); --search-bg: rgba(40, 20, 60, 0.4); --search-focus: rgba(60, 30, 90, 0.6); } }
