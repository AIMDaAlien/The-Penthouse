<script lang="ts">
	// ChatPane V5-04 — Plum Mauve (T-D4 dark)
	...
	const messages: Msg[] = [
		{ id: '1', sender: them, content: 'did you write today?', time: '17:48' },
		{ id: '2', sender: me, content: 'three pages. all bad.', time: '17:49' },
		{ id: '3', sender: them, content: 'bad pages are still pages', time: '17:50', reactions: [{ emoji: '✿', count: 1 }] },
		{ id: '4', sender: me, content: "i know. i'm just tired of the same questions about the same rooms.", time: '17:51' },
		{ id: '5', sender: them, content: 'change the room then', time: '17:52' },
		{ id: '6', sender: me, content: 'to where?', time: '17:53' },
		{ id: '7', sender: them, content: 'somewhere with rain. somewhere that already knows the answer.', time: '17:54' },
		{ id: '8', sender: me, content: 'i like that', time: '17:55' },
		{ id: '9', sender: me, content: 'a rainy attic. somebody else writing the same scene from below.', time: '17:55' },
		{ id: '10', sender: them, content: 'now you have a book', time: '17:56', reactions: [{ emoji: '◇', count: 2 }] },
	];
...
<div class="pane">
	...
	<div class="messages">
		<div class="day-divider">
			...
			<span class="day-label">EVENING</span>
			<span class="day-line"></span>
		</div>
...
<style>
	.pane {
		--p-bg:          oklch(0.17 0.022 340);
		--p-accent:      oklch(0.60 0.090 340);
		--p-accent-soft: oklch(0.60 0.090 340 / 0.20);
		--p-accent-edge: oklch(0.60 0.090 340 / 0.40);
		--p-line:        oklch(0.78 0.060 340 / 0.12);
		--p-line-2:      oklch(0.78 0.060 340 / 0.22);
		--p-secondary:   oklch(0.78 0.050 340);

		position: relative;
		width: 860px; height: 760px;
		background: var(--p-bg);
		color: var(--p-text, oklch(0.93 0.012 340));
	...
	.head-name { font-size: 1.05rem; font-weight: 500; color: var(--p-text, oklch(0.93 0.012 340)); letter-spacing: -0.3px; }
	.head-eyebrow {
	...
	.day-label {
		...
		color: var(--p-muted, oklch(0.65 0.040 340));
	}
	...
	.reaction {
		...
		background: var(--p-surface-2, oklch(0.26 0.030 340));
		border: 1px solid var(--p-line);
	...
	.reaction-n {
		font-family: 'JetBrains Mono', monospace;
		font-size: 0.65rem; color: var(--p-muted, oklch(0.65 0.040 340));
	}
	...
	.composer-placeholder { flex: 1; font-size: 0.9rem; color: var(--p-muted, oklch(0.65 0.040 340)); }
	.composer-send {
