<script lang="ts">
	// ChatPane V5-10 — Oat Stone (T-L7 light)
	// Self-contained prototype. No external imports.
	// CRITICAL: pastel-tinted bubbles + dark text (per V5-HANDOFF risk #6).

	const me = { id: 'me', name: 'You', avatar: 'https://i.pravatar.cc/150?u=oat', status: 'online' as const };
	const them = { id: 'them', name: 'Soren', avatar: 'https://i.pravatar.cc/150?u=soren', status: 'online' as const };
	...
	const messages: Msg[] = [
		{ id: '1', sender: them, content: 'the stone is warm this afternoon', time: '16:18' },
		{ id: '2', sender: them, content: 'i sat on the wall for an hour', time: '16:19' },
		{ id: '3', sender: me, content: 'reading?', time: '16:20' },
		{ id: '4', sender: them, content: 'just watching. the light changes so slowly now.', time: '16:21', reactions: [{ emoji: '◐', count: 1 }] },
		{ id: '5', sender: me, content: 'the days are getting longer', time: '16:22' },
		{ id: '6', sender: them, content: 'by minutes. but you feel it.', time: '16:23' },
		{ id: '7', sender: me, content: 'i will bring bread tomorrow', time: '16:24' },
		{ id: '8', sender: them, content: 'the sourdough?', time: '16:25' },
		{ id: '9', sender: me, content: 'the sourdough', time: '16:26', reactions: [{ emoji: '◇', count: 1 }] },
		{ id: '10', sender: them, content: 'i will make tea', time: '16:27' },
	];
...
<style>
	.pane {
		/* Oat Stone — warm neutral with stone-taupe accent */
		--p-bg:          oklch(0.96 0.012 80);
		--p-text:        oklch(0.22 0.015 80);
		--p-text-2:      oklch(0.40 0.020 80);
		--p-muted:       oklch(0.55 0.025 80);
		--p-accent:      oklch(0.55 0.100 80);
		--p-accent-soft: oklch(0.78 0.070 80 / 0.28);
		--p-accent-edge: oklch(0.55 0.100 80 / 0.32);
		--p-line:        oklch(0.40 0.030 80 / 0.10);
		--p-line-2:      oklch(0.40 0.030 80 / 0.18);
		--p-secondary:   oklch(0.40 0.025 80);
	...
	/* Received bubble — soft oat-tinted */
	.bub {
	...
	/* Own bubble — pastel stone (~25% over bg), dark ink */
	.row.own .bub {
