<script lang="ts">
	// ChatPane V5-07 — Sky Pastel (T-L3 light)
	// Self-contained prototype. No external imports.
	// CRITICAL: pastel-tinted bubbles + dark text (per V5-HANDOFF risk #6).

	const me = { id: 'me', name: 'You', avatar: 'https://i.pravatar.cc/150?u=sky', status: 'online' as const };
	const them = { id: 'them', name: 'Aya', avatar: 'https://i.pravatar.cc/150?u=aya', status: 'online' as const };
	...
	const messages: Msg[] = [
		{ id: '1', sender: them, content: 'the clouds are moving fast today', time: '14:22' },
		{ id: '2', sender: them, content: 'like something is being decided up there', time: '14:23' },
		{ id: '3', sender: me, content: 'rain?', time: '14:24' },
		{ id: '4', sender: them, content: 'maybe. the air feels heavy.', time: '14:25', reactions: [{ emoji: '☁', count: 1 }] },
		{ id: '5', sender: me, content: 'i like it when it rains here. the city gets quiet.', time: '14:26' },
		{ id: '6', sender: them, content: 'the canals turn silver', time: '14:27' },
		{ id: '7', sender: me, content: 'i will bring the umbrella', time: '14:28' },
		{ id: '8', sender: them, content: 'the blue one?', time: '14:29' },
		{ id: '9', sender: me, content: 'the blue one', time: '14:30', reactions: [{ emoji: '◇', count: 1 }] },
		{ id: '10', sender: them, content: 'meet at the bridge', time: '14:31' },
	];
	...
	<header class="head">
		<div class="head-left">
			...
			<div class="head-meta">
				...
				<span class="head-eyebrow">N° 03 / ONLINE</span>
			</div>
		</div>
	</header>
...
<style>
	.pane {
		/* Sky Pastel — cool sky blue with soft blue accent */
		--p-bg:          oklch(0.96 0.018 245);
		--p-text:        oklch(0.22 0.020 245);
		--p-text-2:      oklch(0.40 0.025 245);
		--p-muted:       oklch(0.55 0.030 245);
		--p-accent:      oklch(0.55 0.130 245);
		--p-accent-soft: oklch(0.78 0.090 245 / 0.28);
		--p-accent-edge: oklch(0.55 0.130 245 / 0.32);
		--p-line:        oklch(0.40 0.040 245 / 0.10);
		--p-line-2:      oklch(0.40 0.040 245 / 0.18);
		--p-secondary:   oklch(0.40 0.030 245);
	...
	.reaction {
		...
		background: oklch(0.93 0.018 245);
		border: 1px solid var(--p-line);
