<script lang="ts">
	// ChatPane V5-03 — Slate Blue (T-D3 dark)
	// Self-contained prototype. No external imports.

	const me = { id: 'me', name: 'You', avatar: 'https://i.pravatar.cc/150?u=marcus', status: 'online' as const };
	const them = { id: 'them', name: 'Suki', avatar: 'https://i.pravatar.cc/150?u=suki', status: 'online' as const };
	...
	const messages: Msg[] = [
		{ id: '1', sender: them, content: 'the harbor is quiet tonight', time: '22:04' },
		{ id: '2', sender: them, content: 'every light a held breath', time: '22:05' },
		{ id: '3', sender: me, content: 'i can almost hear it from here', time: '22:06' },
		{ id: '4', sender: them, content: 'are you working late again?', time: '22:07' },
		{ id: '5', sender: me, content: 'one more passage. then bed.', time: '22:08' },
		{ id: '6', sender: me, content: "the part where the architect describes the staircase as a conversation between two floors. i can't get it right.", time: '22:09', reactions: [{ emoji: '◐', count: 1 }] },
		{ id: '7', sender: them, content: 'maybe it doesnt want to be right yet', time: '22:10' },
		{ id: '8', sender: me, content: 'maybe.', time: '22:11' },
		{ id: '9', sender: them, content: 'sleep on it. send me what you have in the morning.', time: '22:12' },
		{ id: '10', sender: me, content: 'thank you', time: '22:13', reactions: [{ emoji: '☾', count: 1 }] },
	];
...
<style>
	.pane {
		--p-bg:          oklch(0.16 0.018 245);
		--p-accent:      oklch(0.62 0.075 245);
		--p-accent-soft: oklch(0.62 0.075 245 / 0.20);
		--p-accent-edge: oklch(0.62 0.075 245 / 0.40);
		--p-line:        oklch(0.78 0.060 245 / 0.12);
		--p-line-2:      oklch(0.78 0.060 245 / 0.22);
		--p-secondary:   oklch(0.78 0.050 245);

		position: relative;
		width: 860px; height: 760px;
		background: var(--p-bg);
		color: var(--p-text, oklch(0.93 0.012 245));
	...
	.head-name { font-size: 1.05rem; font-weight: 500; color: var(--p-text, oklch(0.93 0.012 245)); letter-spacing: -0.3px; }
	.head-eyebrow {
	...
	.day-label {
		...
		color: var(--p-muted, oklch(0.65 0.040 245));
	}
	...
	.reaction {
		...
		background: var(--p-surface-2, oklch(0.26 0.030 245));
		border: 1px solid var(--p-line);
	...
	.reaction-n {
		font-family: 'JetBrains Mono', monospace;
		font-size: 0.65rem; color: var(--p-muted, oklch(0.65 0.040 245));
	}
	...
	.composer-placeholder { flex: 1; font-size: 0.9rem; color: var(--p-muted, oklch(0.65 0.040 245)); }
	.composer-send {
