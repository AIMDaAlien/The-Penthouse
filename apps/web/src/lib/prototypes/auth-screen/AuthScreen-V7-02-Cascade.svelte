<!--
  V7-02 Cascade — five baseline effects + headline letters cascade-fade on first paint.
-->
<script lang="ts">
	...
	import { typeReveal, stagger, letterCascade, tabSwitchIn, tabSwitchOut } from './_shared/motion';
...
<div class="root">
	...
	<article class="article">
		<header class="art-head" use:typeReveal={{ delay: 0 }}>
			...
			<p class="issue-line"><em>One letter at a time.</em></p>
		</header>
		<div class="art-body">
			<h1 class="headline">
				<span use:letterCascade={{ delay: 360, perLetter: 36 }}>Identify yourself,</span><br/>
				<em><span use:letterCascade={{ delay: 1100, perLetter: 36 }}>briefly.</span></em>
			</h1>
			<p class="lead" use:typeReveal={{ delay: stagger(10) }}>
				<span class="dropcap" aria-hidden="true">T</span><span class="dropcap-h">T</span>he letters arrive in order, like a small typing class held at the front desk. They have all afternoon. So do you.
			</p>
		</div>
	</article>
	...
	<aside class="glass-col" use:typeReveal={{ delay: stagger(2) }}>
		<div class="glass">
			<header class="g-head"><span class="g-kicker"><em>Sign-in</em></span><h2 class="g-title">Letter by letter.</h2></header>
			<div class="tabs">
...
<style>
	...
	.a-a { width: 620px; height: 620px; background: oklch(0.69 0.140 285 / 0.55); top: -120px; right: 20%; }
