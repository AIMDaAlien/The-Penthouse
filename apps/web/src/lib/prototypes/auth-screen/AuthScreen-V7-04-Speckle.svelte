<!--
  V7-04 Speckle — five baseline effects + drifting periwinkle dust particles (canvas).
-->
<script lang="ts">
	...
	import { typeReveal, stagger, dustParticles, tabSwitchIn, tabSwitchOut } from './_shared/motion';
...
<div class="root">
	...
	<canvas class="dust" use:dustParticles={{ count: 80, speed: 0.18, tint: 'oklch(0.82 0.080 285 / 0.45)' }} aria-hidden="true"></canvas>

	<article class="article">
		<header class="art-head" use:typeReveal={{ delay: 0 }}>
			<Wordmark size="xl" align="start" />
			<p class="issue-line"><em>The air, considered.</em></p>
		</header>
		<div class="art-body">
			<h1 class="headline" use:typeReveal={{ delay: stagger(1) }}>A house held<br/><em>in suspension.</em></h1>
			<p class="lead" use:typeReveal={{ delay: stagger(2) }}>
				<span class="dropcap" aria-hidden="true">T</span><span class="dropcap-h">T</span>he air is older than the lift. It moves when someone is about to enter. You will notice it doing so now.
			</p>
		</div>
	</article>
	...
	<aside class="glass-col" use:typeReveal={{ delay: stagger(2) }}>
		<div class="glass">
			<header class="g-head"><span class="g-kicker"><em>Sign-in</em></span><h2 class="g-title">Step quietly.</h2></header>
			<div class="tabs">
...
<style>
	...
	@media (prefers-reduced-motion: reduce) { .dust { display: none !important; } .dropcap { animation: none !important; } .tab { transition: none !important; } }
</style>
