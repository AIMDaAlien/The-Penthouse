<!--
  V7-05 Cipher — five baseline effects + headline letters scramble through glyphs then settle.
-->
<script lang="ts">
	...
	import { typeReveal, stagger, scrambleText, tabSwitchIn, tabSwitchOut } from './_shared/motion';
...
<div class="root">
	...
	<article class="article">
		<header class="art-head" use:typeReveal={{ delay: 0 }}>
			...
			<p class="issue-line"><em>The letters arrive disguised.</em></p>
		</header>
		<div class="art-body">
			<h1 class="headline">
				<span use:scrambleText={{ delay: 380, duration: 1000 }}>The name settles,</span><br/>
				<em><span use:scrambleText={{ delay: 1180, duration: 800 }}>the room settles.</span></em>
			</h1>
			<p class="lead" use:typeReveal={{ delay: stagger(10) }}>
				<span class="dropcap" aria-hidden="true">T</span><span class="dropcap-h">T</span>he door spelled itself a thousand ways before lying flat. Yours will only need to spell itself the once.
			</p>
		</div>
	</article>
	...
	<aside class="glass-col" use:typeReveal={{ delay: stagger(2) }}>
		<div class="glass">
			<header class="g-head"><span class="g-kicker"><em>Sign-in</em></span><h2 class="g-title">Settle the name.</h2></header>
			<div class="tabs">
